...
shortAnswer: "Apple's Hearing Test is a five-minute pure-tone check that runs on AirPods Pro 2 or AirPods Pro 3 with an iPhone. A 2026 clinical study found 86.5% of its results within 10 dB of a booth audiogram, which makes it a dependable screen rather than a diagnosis. It doesn't run on AirPods 4 or any other headphones."
takeaways:
  - "It needs AirPods Pro 2 or AirPods Pro 3 on current firmware, an adult, and a quiet room. AirPods 4, AirPods Max, Beats, and every other headphone are outside it."
  - "Against clinic audiometry, a 2026 study put 86.5% of its thresholds within 10 dB and found it repeatable. That's screening-grade, and the audiologists who tested it call it exactly that."
  - "The result is one number per ear in dBHL. Up to 25 is little to no loss, 26 to 40 is mild, 41 to 60 is moderate. It measures how quiet a tone you can hear, not why."
  - "Fit and timing move the number more than anything else. A loose ear tip, a cold this week, or a concert last night can make a good ear look worse than it is."
  - "A mild result with no AirPods Pro leaves Apple's follow-up tools closed to you. If conversations have been getting harder, an audiologist is the next stop. An amplifier app on the headphones you own is the cheap way to learn whether louder helps tonight."
faq:
  ...
  - q: "What do the AirPods Hearing Test results mean?"
    a: "You get one number per ear in decibels of hearing level, an average across the frequencies speech lives in. Up to 25 dBHL is little to no loss. 26 to 40 is mild, where a conversational voice from three feet away is still clear. 41 to 60 is moderate. 61 to 80 is severe. Tap Show Details for the full audiogram, which is saved in the Health app and can be exported as a PDF for a doctor."
  - q: "Why isn't the Hearing Test showing up on my AirPods Pro?"
    a: "Work through the gates in order. The earbuds need their latest firmware and the iPhone its latest iOS. The feature is for people 18 and older, so check the date of birth in your Health profile. It's a regulated health feature, so it only appears in countries where Apple has clearance. Then look under Settings, your AirPods, Hearing Health, or start it from the Health app. If it's there but won't start, the room is too loud or the ear tips aren't sealing."
  - q: "Can I take a hearing test on an iPhone without AirPods?"
    a: "Not Apple's. It's tied to the calibrated tones and sealed tips of AirPods Pro, and there's no iPhone-only version. Third-party test apps exist for other headphones, and they're screenings with the same limit: an unknown headphone playing a tone at an unknown level. If you want a number you can act on without buying AirPods Pro, a hearing clinic is the shorter path."
relatedSlugs:
...
## What the test is, and what it needs
...
## Taking it so the number means something

Most of what makes the result wrong is on your side of the earbuds, and it's fixable.

Seal first. The tones are calibrated for a closed ear canal, so a tip that lets air in also lets the quietest tones out, and a leaky ear tests worse than it hears. Run the Ear Tip Fit Test in your AirPods settings before you start, and if it says try another size, try another size. The Hearing Test checks fit again on its own and will stop and tell you if a tip has shifted.

Then timing. Apple's own guidance is to skip the test if you've had a cold, a sinus infection, or an ear infection in the last day, if allergies are flaring, or if you were somewhere loud like a concert in the last 24 hours. All of those raise your thresholds temporarily, and a number taken on a bad day is a number you'll have to explain away later. Clean the earbuds too. Debris in the mesh changes what reaches your ear.

Then the room. Turn off the fan or the air conditioner rather than fighting the noise check, or wait for the evening. During the test, tap once when you hear a tone and don't chase the ones you're not sure about. If you pull an earbud out or someone starts talking, it pauses and resumes on its own.

The whole procedure is in [Apple's own instructions](https://support.apple.com/en-us/120991). What they don't say is that a second run on a different day is worth doing before you act on the first. The test agrees with itself well enough that two similar results mean something, and two different ones tell you which day was the bad one.
...
The related searches are full of people who can't find it, so check in this order.

The earbuds. AirPods Pro 2 or 3 only. If yours are AirPods 4, the Hearing Health section will be missing entirely, and that's expected rather than broken.

Firmware and software. The earbuds update themselves in the case, charging, near the paired iPhone, and they can lag for weeks. Check the version under Settings, your AirPods, About, and check iOS while you're there.

Age. It's for people 18 and older, and Apple treats that as a requirement rather than a suggestion. Check the date of birth in your Health profile.

Region. It's a regulated health feature, cleared country by country. An iPhone set to a region that isn't cleared yet won't show it.

Then the run itself. If the test is there but keeps stopping, the room is too loud or a tip has shifted. If it asks you to put the earbuds in the case and close the lid, that's a check the test runs on the earbuds; let it finish. And charge them first, which sounds obvious until the test quits at minute four.

## A mild result without AirPods Pro

This is the reader every ranking page skips: you took the test on a borrowed pair, or you own the earbuds but they're not the ones you wear all day, or your result said mild and you've now got a number and no plan. Three routes, in the order I'd take them.
...
If you own AirPods Pro 2 or 3, yes, today, in a quiet room, with tips that seal. It's free, it's five minutes, and the published numbers say the result is worth having. Take it again another day before you act on it.
